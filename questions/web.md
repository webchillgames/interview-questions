...
методы для взаимодействия (например, сайта с сервером)

  
- [Что такое CDN?](https://youtu.be/ngyOYuTrUk8?t=152)

  Content delivery network - копии ресурсов раскинуты по разным серверам и юзеры отдаются данные с ближайшего к нему.

  
- [Что такое IP-адрес?](https://youtu.be/70VnuTXi4Wk?t=720)

  уникальная id узла в сети
  
- [Разница между host и domain?](https://youtu.be/70VnuTXi4Wk?t=779)


host это сервер, domain - адрес сайта
  
- [Разница между URI и URL?](https://youtu.be/70VnuTXi4Wk?t=844)

  
ID ресурса, URL - данные о местоположении
